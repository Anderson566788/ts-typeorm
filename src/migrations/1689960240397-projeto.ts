...
export class Projeto1689960240397 implements MigrationInterface {
    name = 'Projeto1689960240397'
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`ALTER TABLE "rooms" ADD "desription" text`);
    ...
    public async down(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`ALTER TABLE "rooms" DROP COLUMN "desription"`);
